...
| پلتفرم      | فایل                         | حجم            |
| ----------- | ---------------------------- | -------------- |
| Windows x64 | `Rassam_1.1.x_x64-setup.exe` | حدود 6 مگابایت |
...
این پروژه متن‌باز است. برای جزئیات به [مخزن GitHub](https://github.com/A-talebifard/Rassam-persian-memaid-clone/) مراجعه کنید.
...
Go to the [Releases page](https://github.com/A-talebifard/Rassam-persian-memaid-clone/releases) and download the latest version.

| Platform    | File                         | Size |
| ----------- | ---------------------------- | ---- |
| Windows x64 | `Rassam_1.1.0_x64-setup.exe` | 6 MB |
...
- **Desktop App** -- Built with Tauri v2 for a lightweight standalone executable (6 MB on Windows).
...
This project is open source. See the [GitHub repository](https://github.com/A-talebifard/Rassam-persian-memaid-clone/) for details.
